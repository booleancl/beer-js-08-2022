...
> *Git submodules*: If you get ERROR /reveal.js/\*\*/ not found. Probably you didn't use the --recursive option when clonning the repository. Check if your reveal.js folder is empty and run the following in the root of your project: `git submodule update --init`
